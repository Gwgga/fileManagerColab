...
def install_filemanager(bin_dir="/tmp"):
  ...
  if is_apache_avail:
    print("calling wget KodExplorer" )
    get_ipython().system_raw( "wget https://github.com/kalcaddle/KodExplorer/archive/master.zip -O kodexplorer.zip" )
    print("calling mkdir html" )
    get_ipython().system_raw( "mkdir html" )
    print("calling unzip kodexplorer.zip" )
    get_ipython().system_raw( "unzip -o kodexplorer.zip -d /content/html/" )
    print("calling mv filemanager files" )
    get_ipython().system_raw( "mv /content/html/KodExplorer-master/* /content/html/" )
    print("calling chmod /content/html/" )
    get_ipython().system_raw( "chmod 777 -R /content/html/" )
    print("calling chmod /content" )
    get_ipython().system_raw( "chmod 777 -R /content" )
    print("calling wget DocumentRoot" )
